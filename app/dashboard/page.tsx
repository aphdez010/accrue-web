  ...
  return (
    <div style={{ padding: isMobile ? '20px 16px' : 40, maxWidth: 900, width: '100%', boxSizing: 'border-box', minWidth: 0 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 12, marginBottom: 16 }}>
        ...
        {statCard('Projected Completion', d?.projectedCompletionDate === 'complete' ? 'Done ✓' : d?.projectedCompletionDate ? new Date(d.projectedCompletionDate + '-01').toLocaleDateString('en-US', { month: 'long', year: 'numeric', timeZone: 'UTC' }) : '—', 'at current pace', d?.projectedCompletionDate === 'complete' ? 'var(--spruce)' : undefined)}
      </div>
